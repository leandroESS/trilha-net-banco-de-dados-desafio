...
SELECT Nome, Genero from FilmesGenero INNER JOIN Generos ON FilmesGenero.IdGenero = Generos.Id INNER JOIN  Filmes ON Filmes.Id=FilmesGenero.IdFilme

--11 - Buscar o nome do filme e o gênero do tipo "Mistério"
SELECT Nome, Genero 
from FilmesGenero INNER JOIN Generos 
...
SELECT Nome, PrimeiroNome, UltimoNome, Papel FROM ElencoFilme INNER JOIN Filmes ON ElencoFilme.IdFilme=Filmes.Id INNER JOIN Atores ON ElencoFilme.IdAtor=Atores.Id
